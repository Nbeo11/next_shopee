...
export default function Login() {
  ...
  return (
    <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center items-center">
      <div class="max-w-screen-xl m-0 sm:m-10 bg-white sm:rounded-lg flex justify-center flex-1 shadow-lg">
        ...
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          ...
          <div class="mt-12 flex flex-col items-center">
            <h1 class="text-2xl xl:text-3xl font-extrabold">SignUp</h1>
            <div class="w-full flex-1 mt-8">
              <div class="flex flex-col items-center">
                ...
                <button class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                  ...
                  <span class="ml-4">SignUp with GitHub</span>
                </button>
              </div>
              ...
              <form onSubmit={userLogin} className="mx-auto max-w-xs">
                ...
                <input
                  ...
                  v-model="password"
                />
                <button class="mt-5 tracking-wide font-semibold  bg-[#78BCC4] text-gray-900 w-full py-4 rounded-lg hover:bg-[#3c938a] hover:text-white transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
                  SignUp
                </button>

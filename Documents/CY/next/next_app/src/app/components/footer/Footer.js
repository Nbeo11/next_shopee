...
export default function Footer() {
  return (
    <footer className="bg-gray-900 px-10 py-5 font-[sans-serif] tracking-wide">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
        ...
        <div>
          <h4 className="text-md font-semibold mb-2 text-white">Contact Us</h4>
        ...
        <div>
          <h4 className="text-md font-semibold mb-2 text-white">Information</h4>
          <ul className="space-y-1">
            <li>
              <a
                href="javascript:void(0)"

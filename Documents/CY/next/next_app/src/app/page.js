  ...
  return (
    <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-evenly flex-col md:flex-row">
          <div className="relative h-72">
            ...
            <div className="absolute inset-0 flex items-center justify-center px-24 text-justify leading-8">
              Welcome to MiniShop! We’re dedicated to providing quality, trendy
              products that cater to every style. Enjoy a seamless shopping
              experience with our curated collections and friendly customer
              support. Visit us to discover exclusive deals and new arrivals!
            </div>
          </div>
      ...
      <div className="px-10 pb-16">
        ...
        <div className={`${styles.borderAnimated} p-2 text-justify leading-8`}>
